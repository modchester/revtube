          ...
          <div class="span10">
			...
			if($result->num_rows !== 0){
				while($row = $result->fetch_assoc()) {
				    ...
				    <div class='user'>
				    	<div class='user-info'>
						    <div><a href='./profile?user=".$row['username']."'><img class='cmn' height='34px' width='34px' style='padding-right:2px;' src='content/pfp/".getUserPic($row['username']). "'> <b>".$row['username']."</b></a> (".$rows." subscribers)</div>
