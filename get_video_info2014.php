...
if(isset($_GET["v"])) {
$vid = htmlspecialchars($_GET["v"]); // this entire if statement is not required if you are using second method
}
...
$main_data = array(
    ...
    "thumbnail_url" => "../content/thumb/".$vid.".jpg",
    "status" => "ok",
    "has_cc" => "false",
    ...
    "storyboard_spec" => "",
    "abd" => "1",
    "iurlmaxres" => "../content/thumb/".$vid.".jpg",
